...
train_image_dir = r'archive/Data/Train'
validate_image_dir = r'archive/Data/Validation'
test_image_dir = r'archive/Data/Test'
...
clip_classifier = CLIPClassifier(model, num_classes=3).to(device)
